...
// Regular malloc/free
//#define SE_FGG_MALLOC(sz) malloc((sz))
//#define SE_FGG_FREE(sz) free((sz))
...
void SE_FGG_expand_all(SE_FGG_work* work, 
		       ...
		       const SE_FGG_params* params)
{
    double xn[3] __attribute__((aligned(16)));
    const int N = params->N;
    const int P = params->P;
...
void SE_FGG_int(double* restrict phi,  
		...
		const SE_FGG_params* params)
{
    double z2_0[P_MAX] __attribute__((aligned(16)));
    double z2_1[P_MAX] __attribute__((aligned(16)));
    double z2_2[P_MAX] __attribute__((aligned(16)));
		 ...
		 const SE_FGG_params* params)
{
    ...
    double zx0[P_MAX] __attribute__((aligned(16)));
    double zy0[P_MAX] __attribute__((aligned(16)));
    double zz0[P_MAX] __attribute__((aligned(16)));
