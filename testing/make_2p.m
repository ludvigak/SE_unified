...
eval([mex_string ' -DVERBOSE -DEWALD_REAL -DTWO_PERIODIC -DHASIMOTO ' ...
    '../SE_Stokes_direct_mex.c ../SE2P_Stokes_direct.c -o SE2P_Stokes_direct_real_mex'])
eval([mex_string ' -DVERBOSE -DEWALD_RSRC -DTWO_PERIODIC -DHASIMOTO ' ...
    '../SE_Stokes_direct_mex.c ../SE2P_Stokes_direct.c -o SE2P_Stokes_direct_rsrc_mex'])
eval([mex_string ' -DVERBOSE -DEWALD_FD -DTWO_PERIODIC -DHASIMOTO ' ...
    '../SE_Stokes_direct_mex.c ../SE2P_Stokes_direct.c -o SE2P_Stokes_direct_fd_mex'])
eval([mex_string ' -DVERBOSE -DEWALD_K0 -DTWO_PERIODIC -DHASIMOTO ' ...
    '../SE_Stokes_direct_mex.c ../SE2P_Stokes_direct.c -o SE2P_Stokes_direct_k0_mex'])
eval([mex_string ' -DVERBOSE -DEWALD_SELF -DTWO_PERIODIC -DHASIMOTO ' ...
      '../SE_Stokes_direct_mex.c ../SE2P_Stokes_direct.c -o SE2P_Stokes_direct_self_mex'])
