...
eval([mex_string ' -DVERBOSE -DEWALD_REAL -DTHREE_PERIODIC -DHASIMOTO ' ...
    '../SE_Stokes_direct_mex.c ../SE3P_Stokes_direct.c -output SE3P_Stokes_direct_real_mex'])
eval([mex_string ' -DVERBOSE -DEWALD_RSRC -DTHREE_PERIODIC -DHASIMOTO ' ...
    '../SE_Stokes_direct_mex.c ../SE3P_Stokes_direct.c -output SE3P_Stokes_direct_rsrc_mex'])
eval([mex_string ' -DVERBOSE -DEWALD_FD -DTHREE_PERIODIC -DHASIMOTO ' ...
    '../SE_Stokes_direct_mex.c ../SE3P_Stokes_direct.c -output SE3P_Stokes_direct_fd_mex'])
eval([mex_string ' -DVERBOSE -DEWALD_SELF -DTHREE_PERIODIC -DHASIMOTO ' ...
      '../SE_Stokes_direct_mex.c ../SE3P_Stokes_direct.c -output SE3P_Stokes_direct_self_mex'])
