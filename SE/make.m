...
eval([mex_string ' -DVERBOSE -DEWALD_REAL -DTHREE_PERIODIC ../SE_direct/SE_direct_mex.c ../SE_direct/SE3P_direct.c -output SE3P_direct_real_mex'])
eval([mex_string ' -DVERBOSE -DEWALD_RSRC -DTHREE_PERIODIC ../SE_direct/SE_direct_mex.c ../SE_direct/SE3P_direct.c -output SE3P_direct_rsrc_mex'])
eval([mex_string ' -DVERBOSE -DEWALD_FD -DTHREE_PERIODIC ../SE_direct/SE_direct_mex.c ../SE_direct/SE3P_direct.c -output SE3P_direct_fd_mex'])
eval([mex_string ' -DVERBOSE -DEWALD_SELF -DTHREE_PERIODIC ../SE_direct/SE_direct_mex.c ../SE_direct/SE3P_direct.c -output SE3P_direct_self_mex'])
