...
eval([mex_string ' -DFGG_THRD -DTHREE_PERIODIC SE_fg_grid_split_thrd_mex.c ../SE_fast_gridding/SE_fgg.c ../SE_fast_gridding/SE_fgg_MEX_params.c'])

eval([mex_string ' -DFGG_THRD -DTHREE_PERIODIC SE_fg_grid_thrd_mex.c ../SE_fast_gridding/SE_fgg.c ../SE_fast_gridding/SE_fgg_MEX_params.c'])
