...
se_mm256_log_pd(__m256d x)
{
    ...
    mask1     = _mm256_cmp_pd(se_mm256_abs_pd(fexp), two, _CMP_GT_OQ);
    ...
    xA     = _mm256_mul_pd(zA, se_mm256_inv_pd(yA));
   ...
   /* EVALUATE POLY */
    ...
    q      = _mm256_mul_pd(polyR, se_mm256_inv_pd(polyS));
    ...
    q      = _mm256_mul_pd(polyP1, se_mm256_inv_pd(polyQ1));
...
static __m256d
se_mm256_log10_pd(__m256d x)
{
  __m256d ONE_LOG10 = _mm256_set1_pd(0.434294481903251761156781185491);
  return _mm256_mul_pd(se_mm256_log_pd(x),ONE_LOG10);
}
