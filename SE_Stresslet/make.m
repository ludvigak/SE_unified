...
eval([mex_string ' -DFGG_THRD -DTHREE_PERIODIC ../SE_fast_gridding/mex/SE_fg_grid_split_thrd_mex.c ../SE_fast_gridding/SE_fgg.c ../SE_fast_gridding/SE_fgg_MEX_params.c'])
