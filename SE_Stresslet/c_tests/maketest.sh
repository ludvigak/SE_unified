#!/bin/sh
icc -Wall -std=c99 -O3 -DBEENAKKER -DVERBOSE -msse4.1 -static -I ../mex/ ../mex/cell_list.c ../mex/stresslet_real_rc.c test_real_rc.c -o test_real_rc -vec-report -openmp -lm -g
