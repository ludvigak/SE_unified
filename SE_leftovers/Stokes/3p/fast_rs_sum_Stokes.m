function [u wtime] = fast_rs_sum_II(x, f, xi, L, S, verlet)
...
[xe fe] = extend_one_layer(x, f, L, S);
...
tic
u = real_nbh_sum_mex(xe', fe', N, nbh_vec, nbh_len, xi)';
wtime = toc;
...
% ------------------------------------------------------------------------------
function [xe fe] = extend_one_layer(x, f, L, S)
